 ...
 */
class Hybrid_Provider_Model_OAuth2YJP extends Hybrid_Provider_Model
{
	// default permissions 
	public $scope = "";
	...
	*/
	function initialize() 
	{
        ...
        //echo $this->scope;die('   nima');
		// include OAuth2 client
		require_once Hybrid_Auth::$config["path_libraries"] . "OAuth/OAuth2Client_YJP.php";

		// create a new OAuth2 client instance
		$this->api = new OAuth2Client_YJP( $this->config["keys"]["id"], $this->config["keys"]["secret"], $this->endpoint );
